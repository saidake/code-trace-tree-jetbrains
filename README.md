...
<ol>
  <li>Download <code>code-trace-tree-skill-1.3.2.zip</code> from the <a href="https://github.com/saidake/code-trace-tree-jetbrains/releases/tag/v1.3.2">GitHub Release</a> (one zip works across agents).</li>
