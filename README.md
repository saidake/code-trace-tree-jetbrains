...
<p>
  This plugin does <b>not</b> need Node.js. The skill needs Python.
...
<p>
  ...
  They all install the <b>skill</b> the same way (not the plugin).
</p>
<ol>
...
<h4>Linux &amp; macOS</h4>
<pre><code>curl -L https://github.com/saidake/code-trace-tree-jetbrains/releases/download/v1.3.3/code-trace-tree-skill-1.3.3.zip -o code-trace-tree-skill-1.3.3.zip</code>
<code>rm -rf ~/.claude/skills/code-trace-tree</code>
<code>mkdir -p ~/.claude/skills</code>
<code>unzip code-trace-tree-skill-1.3.3.zip -d ~/.claude/skills/</code>
<code>rm code-trace-tree-skill-1.3.3.zip</code>
</pre>
...
<pre><code>Invoke-WebRequest -Uri "https://github.com/saidake/code-trace-tree-jetbrains/releases/download/v1.3.3/code-trace-tree-skill-1.3.3.zip" -OutFile "code-trace-tree-skill-1.3.3.zip"</code>
...
<code>Expand-Archive -Path "code-trace-tree-skill-1.3.3.zip" -DestinationPath "$HOME\.claude\skills" -Force</code>
<code>Remove-Item "code-trace-tree-skill-1.3.3.zip"</code>
</pre>
...
<p>
  ...
  The plugin does not need Node.js.
