...
<pre><code>curl -L https://github.com/saidake/code-trace-tree-jetbrains/releases/download/v1.2.6/code-trace-tree-skill-1.2.6.zip -o code-trace-tree-skill-1.2.6.zip</code>
...
<pre><code>Invoke-WebRequest -Uri "https://github.com/saidake/code-trace-tree-jetbrains/releases/download/v1.2.6/code-trace-tree-skill-1.2.6.zip" -OutFile "code-trace-tree-skill-1.2.6.zip"</code>
