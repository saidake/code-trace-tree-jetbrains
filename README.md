...
<pre><code>curl -L https://github.com/saidake/code-trace-tree-jetbrains/releases/download/v1.1.5/code-trace-tree-skill-1.1.5.zip -o code-trace-tree-skill-1.1.5.zip</code>
...
<pre><code>Invoke-WebRequest -Uri "https://github.com/saidake/code-trace-tree-jetbrains/releases/download/v1.1.5/code-trace-tree-skill-1.1.5.zip" -OutFile "code-trace-tree-skill-1.1.5.zip"</code>
